...
extern "C" {
    ...
    fn rio_make_ipv6_tcp_server_socket(ipv6_addr: libc::in6_addr, port: u16, pfd: *mut i32) -> i32;

    pub fn io_uring_submit(ring: *mut io_uring) -> i32;
    pub fn io_uring_get_sqe(ring: *mut io_uring) -> *mut io_uring_sqe;
    pub fn io_uring_wait_cqe(ring: *mut io_uring, cqe_ptr: *mut *mut io_uring_cqe) -> i32;
    pub fn io_uring_peek_cqe(ring: *mut io_uring, cqe_ptr: *mut *mut io_uring_cqe) -> i32;
    ...
    pub fn io_uring_prep_link_timeout(sqe: *mut io_uring_sqe, ts: *mut fiona::libc::kernel_timespec, flags: u32);
    ...
    pub fn io_uring_prep_connect(sqe: *mut io_uring_sqe, sockfd: i32, addr: *const libc::sockaddr, addrlen: u32);

    pub fn io_uring_prep_read(sqe: *mut io_uring_sqe, fd: i32, buf: *mut libc::c_void, nbytes: u32, offset: u64);

    pub fn io_uring_prep_write(sqe: *mut io_uring_sqe, fd: i32, buf: *const libc::c_void, nbytes: u32, offset: u64);

    pub fn io_uring_prep_cancel(sqe: *mut io_uring_sqe, user_data: *mut libc::c_void, flags: i32);

    pub fn io_uring_prep_timeout(sqe: *mut io_uring_sqe, ts: *mut fiona::libc::kernel_timespec, count: u32, flags: u32);
...
pub fn make_ipv4_tcp_server_socket(ipv4_addr: u32, port: u16) -> Result<i32, i32> {
    let mut fd = -1;
...
pub fn make_ipv6_tcp_server_socket(ipv6_addr: libc::in6_addr, port: u16) -> Result<i32, i32> {
    let mut fd = -1;
    let err = unsafe { rio_make_ipv6_tcp_server_socket(ipv6_addr, port, &mut fd) };
